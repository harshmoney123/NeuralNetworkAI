...
//	Name: C2DMatrix.h
//
//  Author: Harsha Vankayalapati 2016
//
//  Desc: Matrix class 
//
//------------------------------------------------------------------------
...
private:
  ...
  struct SMatrix
  {
    ...
    friend ostream &operator<<(ostream& os, const SMatrix &rhs)
	  {
  ...
  inline void  SMatrixMultiply(SMatrix &mIn);
...
public:
    ...
    void Identity(size_t row, size_t col);
...
inline void CMatrix::SMatrixMultiply(SMatrix &mIn)
{
	SMatrix mat_temp;
...
inline void CMatrix::TransformSPoints(vector<SPoint> &vPoint)
{
